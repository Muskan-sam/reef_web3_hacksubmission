...
export declare const REEF_CHAIN = "reef";
export declare const TESTNET_REEF = "reef_testnet";
export declare const MAINNET_REEF = "reef_mainnet";
...
export interface ProxyProvider {
    ...
    getContractFactory: (contract: string, signer?: ProxySigner | string) => Promise<ContractFactory>;
