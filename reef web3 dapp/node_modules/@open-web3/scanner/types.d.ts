...
export declare type WsProvider = _WsProvider;
export declare type RpcProvider = _WsProvider | HttpProvider;
export declare type Hex = string;
export declare type Bytes = string;
export declare type Confirmation = 'finalize' | number | null;
...
export declare type RegisteredTypes = _RegisteredTypes;
...
export declare type SubscribeBlock = {
    blockNumber: number;
    result: Block & {
        chainInfo: ChainInfo;
    };
...
export declare type SubscribeBlockError = {
    blockNumber: number;
    error: any;
    result: null;
};
